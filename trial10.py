...
class Crime:
    def __init__(abc, root):
        ...
        caseentry = ttk.Entry(uf, textvariable=abc.var_case_id, width=20, font=("arial", 11, "bold"))
        ...
        txt_criminal_no = ttk.Entry(uf, textvariable=abc.var_criminal_no, width=20,
                                    font=("arial", 11, "bold"))
        ...
        txt_Name = ttk.Entry(uf, textvariable=abc.var_name, width=20, font=("arial", 11, "bold"))
        txt_Name.grid(row=1, column=1, sticky=W, padx=2, pady=7)

        # NickName
        lbl_pincode = Label(uf, font=("arial", 12, "bold"), text="Pincode:", bg="white")
        lbl_pincode.grid(row=1, column=2, sticky=W, padx=2, pady=7)

        txt_pincode = ttk.Entry(uf, textvariable=abc.var_pincode, width=20, font=("arial", 11, "bold"))
        txt_pincode.grid(row=1, column=3, padx=2, pady=7)

        # Arrest Date
        lbl_arrestDate = Label(uf, font=("arial", 12, "bold"), text="ArrestDate:", bg="white")
        lbl_arrestDate.grid(row=2, column=0, sticky=W, padx=2, pady=7)

        txt_arrestDate = ttk.Entry(uf, textvariable=abc.var_arrest_date, width=20, font=("arial", 11, "bold"))
        txt_arrestDate.grid(row=2, column=1, padx=2, pady=7)

        # Date of Crime
        lbl_dateOfCrime = Label(uf, font=("arial", 12, "bold"), text="DateofCrime:", bg="white")
        lbl_dateOfCrime.grid(row=2, column=2, sticky=W, padx=2, pady=7)

        txt_dateOfCrime = ttk.Entry(uf, textvariable=abc.var_date_of_crime, width=20,
                                    font=("arial", 11, "bold"))
        ...
        txt_address = ttk.Entry(uf, textvariable=abc.var_address, width=20, font=("arial", 11, "bold"))
        ...
        txt_age = ttk.Entry(uf, textvariable=abc.var_age, width=20, font=("arial", 11, "bold"))
        ...
        txt_occupution = ttk.Entry(uf, textvariable=abc.var_occupation, width=20, font=("arial", 11, "bold"))
        ...
        txt_birthmark = ttk.Entry(uf, textvariable=abc.var_birthMark, width=20, font=("arial", 11, "bold"))
        ...
        txt_crimeType = ttk.Entry(uf, textvariable=abc.var_crime_type, width=20, font=("arial", 11, "bold"))
        ...
        txt_fatherName = ttk.Entry(uf, textvariable=abc.var_father_name, width=20, font=("arial", 11, "bold"))
