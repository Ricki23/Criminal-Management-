...
class Login:
    def __init__(self, root):
        ...
        img=Image.open("police4.png")
        img1=img.resize((100,100),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lblimg1=Label(image=self.photoimage1,bg="black",borderwidth=0)
        lblimg1.place(x=90,y=10,width=70,height=70)
...
class Crime:
    def __init__(abc, root):
        ...
        caseentry = ttk.Entry(uf, textvariable=abc.var_case_id, width=22, font=("calibri", 11, "bold"))
        caseentry.grid(row=0, column=1, padx=2, pady=10, sticky=W)

        # Criminal NO
        lbl_criminal_no = Label(uf, font=("calibri", 12, "bold"), text="Criminal NO:", bg="white")
        ...
        # Criminal Name
        lbl_Name = Label(uf, font=("calibri", 12, "bold"), text="Criminal Name:", bg="white")
        lbl_Name.grid(row=1, column=0, sticky=W, padx=2, pady=7)

        txt_Name = ttk.Entry(uf, textvariable=abc.var_name, width=22, font=("calibri", 11, "bold"))
        txt_Name.grid(row=1, column=1, sticky=W, padx=2, pady=7)

        # NickName
        lbl_pincode = Label(uf, font=("calibri", 12, "bold"), text="Pincode:", bg="white")
        lbl_pincode.grid(row=1, column=2, sticky=W, padx=2, pady=7)

        txt_pincode = ttk.Entry(uf, textvariable=abc.var_pincode, width=22, font=("calibri", 11, "bold"))
        txt_pincode.grid(row=1, column=3, padx=2, pady=7)

        # Arrest Date
        lbl_arrestDate = Label(uf, font=("calibri", 12, "bold"), text="Arrest Date:", bg="white")
        lbl_arrestDate.grid(row=2, column=0, sticky=W, padx=2, pady=7)

        txt_arrestDate = ttk.Entry(uf, textvariable=abc.var_arrest_date, width=22, font=("calibri", 11, "bold"))
        txt_arrestDate.grid(row=2, column=1, padx=2, pady=7)

        # Date of Crime
        lbl_dateOfCrime = Label(uf, font=("calibri", 12, "bold"), text="Date of Crime:", bg="white")
        ...
        # Address
        lbl_address = Label(uf, font=("calibri", 12, "bold"), text="Address:", bg="white")
        lbl_address.grid(row=3, column=0, sticky=W, padx=2, pady=7)

        txt_address = ttk.Entry(uf, textvariable=abc.var_address, width=22, font=("calibri", 11, "bold"))
        txt_address.grid(row=3, column=1, padx=2, pady=7)

        # Age
        lbl_age = Label(uf, font=("calibri", 12, "bold"), text="Age:", bg="white")
        lbl_age.grid(row=3, column=2, sticky=W, padx=2, pady=7)

        txt_age = ttk.Entry(uf, textvariable=abc.var_age, width=22, font=("calibri", 11, "bold"))
        txt_age.grid(row=3, column=3, padx=2, pady=7)

        # occupution
        lbl_occupution = Label(uf, font=("calibri", 12, "bold"), text="Occupation:", bg="white")
        lbl_occupution.grid(row=4, column=0, sticky=W, padx=2, pady=7)

        txt_occupution = ttk.Entry(uf, textvariable=abc.var_occupation, width=22, font=("calibri", 11, "bold"))
        txt_occupution.grid(row=4, column=1, padx=2, pady=7)

        # birthMark
        lbl_birthMark = Label(uf, font=("calibri", 12, "bold"), text="Birth Mark:", bg="white")
        lbl_birthMark.grid(row=4, column=2, sticky=W, padx=2, pady=7)

        txt_birthmark = ttk.Entry(uf, textvariable=abc.var_birthMark, width=22, font=("calibri", 11, "bold"))
        txt_birthmark.grid(row=4, column=3, sticky=W, padx=2, pady=7)

        # Crime Type
        lbl_crimeType = Label(uf, font=("calibri", 12, "bold"), text="Crime Type:", bg="white")
        lbl_crimeType.grid(row=0, column=4, sticky=W, padx=2, pady=7)

        txt_crimeType = ttk.Entry(uf, textvariable=abc.var_crime_type, width=22, font=("calibri", 11, "bold"))
        txt_crimeType.grid(row=0, column=5, padx=2, pady=7)

        # # Father Name
        lbl_fatherName = Label(uf, font=("calibri", 12, "bold"), text="Father Name:", bg="white")
        lbl_fatherName.grid(row=1, column=4, sticky=W, padx=2, pady=7)

        txt_fatherName = ttk.Entry(uf, textvariable=abc.var_father_name, width=22, font=("calibri", 11, "bold"))
        ...
        lbl_gender = Label(uf, font=("calibri", 12, "bold"), text="Gender:", bg="white")
        ...
        lbl_wanted = Label(uf, font=("calibri", 12, "bold"), text="Most Wanted:", bg="white")
        ...
        btn_add = Button(button_frame, text="Record Save", command=abc.add_data, font=("calibri", 13, "bold"), width=14,
                         bg='blue', fg='white')
        btn_add.grid(row=0, column=0, padx=3, pady=5)

        btn_update = Button(button_frame, text="Update", command=abc.update_data, font=("calibri", 13, "bold"), width=14,
                            bg='blue', fg='white')
        btn_update.grid(row=0, column=1, padx=1, pady=5)

        btn_delete = Button(button_frame, text="Delete", command=abc.delete_data, font=("calibri", 13, "bold"), width=14,
                            bg='blue', fg='white')
        btn_delete.grid(row=0, column=2, padx=1, pady=5)

        btn_clear = Button(button_frame, text="Clear", command=abc.reset_data, font=("calibri", 13, "bold"), width=14,
                           bg='blue', fg='white')
        btn_clear.grid(row=0, column=3, padx=1, pady=5)

        lm4 = Image.open('th.jfif')
        ...
        search_by = Label(search_frame, font=("calibri", 11, "bold"), text="Search By:", fg="white", bg="red")
        ...
        com_txt_search = ttk.Combobox(search_frame, textvariable=abc.var_com_search, state="readonly",
                                      font=("calibri", 12, "bold"), width=18)
        com_txt_search['value'] = ("Select Option", "Case_id", "Criminal_no","Pincode","Age")
        com_txt_search.current(0)
        com_txt_search.grid(row=0, column=1, sticky=W, padx=5)

        abc.var_search = StringVar()
        txt_search = ttk.Entry(search_frame, textvariable=abc.var_search, width=22, font=("calibri", 11, "bold"))
        txt_search.grid(row=0, column=2, padx=5)

        btn__search = Button(search_frame, text="Search", command=abc.serach_data, font=("calibri", 11, "bold"),
                             width=14, bg="blue", fg="white")
        btn__search.grid(row=0, column=3, padx=5)

        btn_ShowAll = Button(search_frame, text="Show All", command=abc.fetch_data, font=("calibri", 11, "bold"),
                             width=14, bg="blue", fg="white")
        ...
        abc.criminal_table.heading("4", text="Pin-Code")
    ...
    def add_data(abc):
        if abc.var_criminal_no.get() == "" or abc.var_pincode.get() == "":
        ...
        if abc.var_criminal_no.get() == "" or abc.var_pincode.get() == "":
            ...
            try:
                ...
                if update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        'update criminal1 set Criminal_no=%s,Criminal_name=%s,Pincode=%s,arrest_date=%s,dateOfcrime=%s,address=%s,age=%s,occupation=%s,BirthMark=%s,crimeType=%s,fatherName=%s,gender=%s,wanted=%s where Case_id=%s',
                        (
