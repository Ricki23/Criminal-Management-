...
class Crime:
    def __init__(abc, root):
        ...
        abc.root.title('CRIMINAL MANAGENET SYSTEM SOFTWARE')
        ...
        labelcrime = Label(uf, font=("arial", 12, "bold"), text="Criminal NO:", bg="white")
        labelcrime.grid(row=0, column=2, sticky=W, padx=2, pady=7)

        # Criminal NO


        textcrime = ttk.Entry(uf, textvariable=abc.var_criminal_no, width=22,
                                    font=("arial", 11, "bold"))
        textcrime.grid(row=0, column=3, padx=2, pady=7)

        # Criminal Name
        Name = Label(uf, font=("arial", 12, "bold"), text="Criminal Name:", bg="white")
        Name.grid(row=1, column=0, sticky=W, padx=2, pady=7)

        TextName = ttk.Entry(uf, textvariable=abc.var_name, width=22, font=("arial", 11, "bold"))
        TextName.grid(row=1, column=1, sticky=W, padx=2, pady=7)

        # NickName
        labelnick = Label(uf, font=("arial", 12, "bold"), text="NickName:", bg="white")
        labelnick.grid(row=1, column=2, sticky=W, padx=2, pady=7)

        TextNick = ttk.Entry(uf, textvariable=abc.var_nickname, width=22, font=("arial", 11, "bold"))
        TextNick.grid(row=1, column=3, padx=2, pady=7)

        # Arrest Date
        labelarrest = Label(uf, font=("arial", 12, "bold"), text="Arrest Date:", bg="white")
        labelarrest.grid(row=2, column=0, sticky=W, padx=2, pady=7)

        textArrest = ttk.Entry(uf, textvariable=abc.var_arrest_date, width=22, font=("arial", 11, "bold"))
        textArrest.grid(row=2, column=1, padx=2, pady=7)

        # Date of Crime
        labeldate = Label(uf, font=("arial", 12, "bold"), text="Date of Crime:", bg="white")
        labeldate.grid(row=2, column=2, sticky=W, padx=2, pady=7)

        textcrime = ttk.Entry(uf, textvariable=abc.var_date_of_crime, width=22,
                                    font=("arial", 11, "bold"))
        textcrime.grid(row=2, column=3, sticky=W, padx=2, pady=7)

        # Address
        labeladdress = Label(uf, font=("arial", 12, "bold"), text="Address:", bg="white")
        labeladdress.grid(row=3, column=0, sticky=W, padx=2, pady=7)

        textaddress = ttk.Entry(uf, textvariable=abc.var_address, width=22, font=("arial", 11, "bold"))
        textaddress.grid(row=3, column=1, padx=2, pady=7)

        # Age
        labelage = Label(uf, font=("arial", 12, "bold"), text="Age:", bg="white")
        labelage.grid(row=3, column=2, sticky=W, padx=2, pady=7)

        textage = ttk.Entry(uf, textvariable=abc.var_age, width=22, font=("arial", 11, "bold"))
        textage.grid(row=3, column=3, padx=2, pady=7)

        # occupution
        labeloccupation = Label(uf, font=("arial", 12, "bold"), text="Occupation:", bg="white")
        labeloccupation.grid(row=4, column=0, sticky=W, padx=2, pady=7)

        textoccupation = ttk.Entry(uf, textvariable=abc.var_occupation, width=22, font=("arial", 11, "bold"))
        textoccupation.grid(row=4, column=1, padx=2, pady=7)

        # birthMark
        labelbirthmark = Label(uf, font=("arial", 12, "bold"), text="Birth Mark:", bg="white")
        labelbirthmark.grid(row=4, column=2, sticky=W, padx=2, pady=7)

        textbirthmark = ttk.Entry(uf, textvariable=abc.var_birthMark, width=22, font=("arial", 11, "bold"))
        textbirthmark.grid(row=4, column=3, sticky=W, padx=2, pady=7)

        # Crime Type
        labelcrimetype = Label(uf, font=("arial", 12, "bold"), text="Crime Type:", bg="white")
        labelcrimetype.grid(row=0, column=4, sticky=W, padx=2, pady=7)

        textcrimetype = ttk.Entry(uf, textvariable=abc.var_crime_type, width=22, font=("arial", 11, "bold"))
        textcrimetype.grid(row=0, column=5, padx=2, pady=7)

        # # Father Name
        labelfathername = Label(uf, font=("arial", 12, "bold"), text="Father Name:", bg="white")
        labelfathername.grid(row=1, column=4, sticky=W, padx=2, pady=7)

        textfathername = ttk.Entry(uf, textvariable=abc.var_father_name, width=22, font=("arial", 11, "bold"))
        textfathername.grid(row=1, column=5, padx=2, pady=7)

        # Radio Frame
        radio_frame_gender = Frame(uf, bd=2, relief=RIDGE, bg='white')
        radio_frame_gender.place(x=730, y=90, width=190, height=30)

        labelgender = Label(uf, font=("arial", 12, "bold"), text="Gender:", bg="white")
        labelgender.grid(row=2, column=4, sticky=W, padx=2, pady=7)
        ...
        labelwanted = Label(uf, font=("arial", 12, "bold"), text="Most Wanted:", bg="white")
        labelwanted.grid(row=3, column=4, sticky=W, padx=2, pady=7)
        ...
        # Button Frame
        bf = Frame(uf, bd=2, relief=RIDGE, bg='white')
        bf.place(x=5, y=200, width=620, height=45)

        btn_add = Button(bf, text="Record Save", command=abc.add_data, font=("arial", 13, "bold"), width=14,
                         bg='blue', fg='white')
        btn_add.grid(row=0, column=0, padx=3, pady=5)

        btn_update = Button(bf, text="Update", command=abc.update_data, font=("arial", 13, "bold"), width=14,
                            bg='blue', fg='white')
        btn_update.grid(row=0, column=1, padx=1, pady=5)

        btn_delete = Button(bf, text="Delete", command=abc.delete_data, font=("arial", 13, "bold"), width=14,
                            bg='blue', fg='white')
        btn_delete.grid(row=0, column=2, padx=1, pady=5)

        btn_clear = Button(bf, text="Clear", command=abc.reset_data, font=("arial", 13, "bold"), width=14,
                           bg='blue', fg='white')
